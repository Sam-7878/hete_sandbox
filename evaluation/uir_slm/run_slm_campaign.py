    ...
    with args.out.open(mode, encoding="utf-8", newline="\n") as handle:
        for case in cases:
            for pipeline in args.pipelines:
                ...
                metrics = evaluate_claims(expected, generated, accepted); numeric = numeric_dimensions(expected, generated) if args.suite in {"numeric", "real_fact"} else {}
