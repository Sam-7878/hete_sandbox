...
The optional RiskEvidence Quarantine extension is implemented at source commit `dcf07a26308146a8766b9d8f07f0fc85a7d5b3a0`.
...
Release B-RE1 results (30 samples, 100,000 inner iterations, 20,000 warmups) had median evaluator latency of 1.849 ns disabled, 18.816 ns insufficient, and 18.890 ns Quarantine on the recorded Ubuntu/WSL2 host. B-RE2 contains all 64 requested threshold combinations over a fixed 16-record synthetic corpus. These numbers are implementation-local and do not establish production detection accuracy.
